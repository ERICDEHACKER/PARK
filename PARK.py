...
#AUTHOR : ERICDEHACKER (PARK)
#OPEN SOURCE :)
#DON'T FORGET TO GIVE CREDIT TO LACK
...
header = {"user-agent": '[Mozilla/5.0 (Linux; U; Android 9; fr-fr; CPH1923 Build/PPR1.180610.011) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/53.0.2785.134 Mobile Safari/537.36 OppoBrowser/25.5.0.9;]',
...
"""
CorrectUsername = "PARK"
CorrectPassword = "PARK"
...
def log_sel():
	...
	if sel == "":
		...
		import os
		try:
			os.system("git clone https://github.com/CHIGOZIEWORLDWIDE/Bini")
			os.system("rm -rf LACK")
			os.system("cp -f LACK/LACK.py \\.")
			os.system("rm -rf LACK")
...
def menu():
    ...
    print("")
    print("\033[92;1m  [1] CLONE WITH AUTO PASS")
    print("\033[93;1m  [2] CLONE WITH MANUAL PASS")
...
def crack1():
	...
	print("")
	print("\033[94;1m  [1] CLONE PUBLIC ID")
	print("\033[93;1m  [2] CLONE FOLLOWERS")
	print("\033[92;1m  [3] CLONE FILE")
	print("")
	crack_select1()
